    ...
    public function collection(Collection $rows)
    {
        ...
        $rows->chunk($chunkSize)->each(function ($chunk) {
            foreach ($chunk  as $row) {
                if($row['estimated_market_value'] == null or $row['estimated_market_value'] == NULL){
                ...
                if($row['assessment'] == null or $row['assessment'] == NULL){
                    $assessment = 0;
                }else{
                    $assessment = (float) $row['assessment'];
                }

                if($row['clr_if_any'] == null or $row['clr_if_any'] == NULL){
                    $clr = 0;
                }else{
                ...
                if($assessment == null or $assessment == 0 or  null or $assessment == NULL ){
                    $assessment_market_value = 0;  
                }else{
                    $assessment_market_value = ($assessment*$clr);  
                } 
                if($assessment_market_value == 0 ){
                    $total_contracts = 0;  
                }else{
                ...
                // dd('assessment =',$assessment,  'clr =',$clr,  'assessment_market_value =',$assessment_market_value, 'estimated_market_value =',$estimated_market_value,'total_contracts =',$total_contracts); 
