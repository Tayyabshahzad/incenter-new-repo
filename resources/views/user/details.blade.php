                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-6 mb-5">
                                            ...
                                            <select class="form-control user_type" data-control="select2"
                                                ...
                                                <option value="entity" @if ($user->user_type == 'entity') selected @endif>     Entity </option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-10">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <input type="number" placeholder="12345" class="form-control" name="zip" id="zip_code"  max="5"
